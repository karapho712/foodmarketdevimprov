        ...
        SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(NumberFormat.currency(symbol: 'IDR ', decimalDigits: 0, locale: 'id-ID').format(transaction!.total!),
            ...
            children: [
              ...
              (transaction!.status! == TransactionStatus.cancelled)
                  ...
                  : (transaction!.status! == TransactionStatus.pending)
                      ? Text('Pending', style: GoogleFonts.poppins(color: 'D9435E'.toColor(), fontSize: 10))
